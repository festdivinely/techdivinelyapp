                    ...
                    <div className="flex flex-wrap items-center -mx-3">
                        <div className="order-1 w-full px-3 lg:w-1/2 lg:order-0">
                            <div className="w-full lg:max-w-md">
                                <h2 className="mb-4 text-2xl font-bold leading-tight text-gray-900 md:text-4xl">What Our Users Are Saying</h2>
                                <div className="flex flex-wrap">
                                    <div className="relative flex flex-col justify-center p-6 mt-6 bg-white rounded-md shadow-lg">
                                        <div className="absolute flex items-center justify-center w-12 h-12 text-white bg-blue-600 rounded-full top-6 right-6">
                                            <svg className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                                <path d="M1 12l4 4 4-4-4-4-4 4z"></path>
                                                <path d="M5 12h14"></path>
                                                <path d="M19 12l-4 4-4-4 4-4 4 4z"></path>
                                            </svg>
                                        </div>
                                        <p className="mb-4 text-base leading-relaxed text-gray-600">"This service has transformed the way we work and has saved us countless hours. The automation and productivity tools are top-notch!"</p>
                                        <p className="text-lg font-semibold text-gray-800">Alex Johnson</p>
                                    ...
                                    <div className="relative flex flex-col justify-center p-6 mt-6 bg-white rounded-md shadow-lg">
                                        ...
                                        <p className="mb-4 text-base leading-relaxed text-gray-600">"Incredible tools and a great experience. The user interface is intuitive, and the customer support team is fantastic."</p>
                                        <p className="text-lg font-semibold text-gray-800">Jamie Lee</p>
                                        <p className="text-sm text-gray-500">Product Manager, Creative Solutions</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="order-0 w-full px-3 lg:w-1/2 lg:order-1">
                            <div className="w-full h-full bg-cover rounded-md shadow-lg" style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1581092331127-d9c289dbe50a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MXwyNzI1NzN8MHwxfGFsbHwxfHx8fHx8fHwxNjE2NjkwNjY1&ixlib=rb-1.2.1&q=80&w=1080")' }}>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="container flex flex-col items-start mx-auto lg:items-center">
                        ...
                        <div className="items-center justify-center w-full mt-12 mb-4 lg:flex">
                            ...
                            <div className="flex flex-col items-start justify-start w-full h-auto px-0 mx-0 mb-12 border-l border-r border-transparent lg:w-1/3 lg:mb-0 lg:px-8 lg:mx-8 lg:border-gray-200">
                                ...
                                <blockquote className="mt-8 text-lg text-gray-500">"Thanks for creating this service. My life is so much easier. Thanks for making such a great product."</blockquote>
                            </div>
                            <div className="flex flex-col items-start justify-start w-full h-auto lg:w-1/3">
                                ...
                                <blockquote className="mt-8 text-lg text-gray-500">"Packed with awesome content and exactly what I was looking for. I would highly recommend this to anyone."</blockquote>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid max-w-md mx-auto mt-6 overflow-hidden leading-7 text-gray-900 border border-b-4 border-gray-300 border-blue-600 rounded-xl md:max-w-lg lg:max-w-none sm:mt-10 lg:grid-cols-3">
                        <div className="box-border px-4 py-8 mb-6 text-center bg-white border-solid lg:mb-0 sm:px-4 sm:py-8 md:px-8 md:py-12 lg:px-10">
                            ...
                            <div className="flex items-center justify-center mt-6 leading-7 text-gray-900 border-0 border-solid sm:mt-8">
                                <p className="box-border m-0 text-6xl font-semibold leading-tight text-blue-600 border-0 border-solid sm:text-6xl md:text-7xl">
                                    $29
                                </p>
                                <p className="ml-2 box-border text-xl leading-tight text-gray-900 border-0 border-solid sm:text-xl md:text-2xl">
                                    /month
                                </p>
                            </div>
                            <a className="mt-8 inline-block px-6 py-3 text-lg font-medium leading-tight text-white bg-blue-600 border border-transparent rounded-lg shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2" href="#">
                                Get Started
                            </a>
                        </div>
                        <div className="box-border px-4 py-8 mb-6 text-center bg-white border-solid lg:mb-0 sm:px-4 sm:py-8 md:px-8 md:py-12 lg:px-10">
